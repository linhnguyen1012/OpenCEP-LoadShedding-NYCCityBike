...
LOAD_SHEDDING_ENABLED = False  # whether load shedding is enabled
LOAD_SHEDDING_STRATEGY = "simple"  # default load shedding strategy: simple, efficient, fifo, batched, random, priority
MAX_PARTIAL_MATCHES = 1000  # maximum number of partial matches before load shedding kicks in
